				...
				<div class="col-lg-6">
					<div class="login_form_inner">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <div class="col-md-12 form-group">
                            <input placeholder="Masukan ulang password" id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
